...
import model from '../../assets/Diverse/Billeder der kan bruges i tekster/rangefinder grafik.jpg';
...
class Rangefinders extends Component {
    render() { 
        ...
        <h1 style={{paddingTop: 20, paddingBottom: 20}}>Brugte Rangefinders</h1>

        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>

        <p className="italic">Her er lidt grafik der viser rangefinderens principper:</p>
